...
import Slide from "./Slide"; // Assuming Slide component is in the same directory
import "../slide_show/slide_show.css"; // Make sure to create a CSS file with the contents from your styles
        ...
        {slides.map((imgSrc, index) => (
          ...
          >
            <div className="contentss">
              <h2 className="titless">{imgSrc.name}</h2>
              <p className="descriptionss">{imgSrc.description}</p>
